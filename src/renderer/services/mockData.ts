...
export const diagnostics: CompileDiagnostic[] = [
  { severity: "info", message: "PortfolioAnalysis compiled with Local compiler adapter.", location: "portfolio-analysis.bks:1" },
...
export const reportPreview: ReportPreview = {
  ...
  sections: [
    ...
    },
    {
      ...
      body: "Report values are generated from the compiled BickSpec specification and staged for PDF, Excel, and CSV export."
    },
    {
